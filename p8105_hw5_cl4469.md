...
rej_esti_df |>
  ...
  scale_x_continuous(breaks = seq(0,6,1)) +
  scale_y_continuous(breaks = seq(0,6,1)) +
  labs(x = "True Value of Mu", y = "Average Estimate of Mu( Null was rejected)", title = "Average Estimate of Mu for which the Null was Rejected VS True Value of Mu")
```
...
<img src="p8105_hw5_cl4469_files/figure-gfm/unnamed-chunk-13-1.png" width="95%" />
